...
form.addEventListener("submit", function (e) {
  ...
  if (question_sum <= 8) {
    ...
    description.textContent =
      "你的心理彈性程度低，不妨散散步讓自己輕鬆一下，向你的朋友及家人分享你的感受。除了放鬆心情之外，我們建議你可以考慮輔導服務，我們很樂意為你提供一對一免費線上諮詢服務，讓你進一步了解自己的狀況。";
      color = "#F48847";
  } else if (question_sum <= 16) {
    category.textContent = "心理韌性程度中";
    description.textContent =
      "你的心理彈性程度中，不妨散散步讓自己輕鬆一下，向你的朋友及家人分享你的感受，還可以看看我們為你準備的身心健康貼士，或參加我們在線舉辦的工作坊啊！";
      color = "#FFC84A";
  } else {
