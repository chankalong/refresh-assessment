...
form.addEventListener("submit", function (e) {
  ...
  if (question_sum <= 2) {
    category.textContent = "沒有壓力";
    description.textContent =
      "你的情緒很健康啊，真好！";
      color = "#4EC04E";
  } else if (question_sum <= 5) {
    category.textContent = "輕微壓力";
    description.textContent =
      "你可能有輕微壓力，不妨散散步讓自己輕鬆一下，向你的朋友及家人分享你的感受，還可以看看我們為你準備的身心健康貼士，或參加我們在線舉辦的工作坊啊！";
      color = "#FFC84A";
  } else {
    category.textContent = "中度壓力或以上";
    description.textContent =
      "你可能有中度壓力或以上，不妨散散步讓自己輕鬆一下，向你的朋友及家人分享你的感受。除了放鬆心情之外，我們建議你可以考慮輔導服務，我們很樂意為你提供一對一免費線上諮詢服務，讓你進一步了解自己的狀況。";
      color = "#F48847";
  }
  ...
  var data = [
    {
      ...
      mode: "gauge+number",
      gauge: {
        axis: { range: [0, 16], tickvals: [0, 8, 16] },
