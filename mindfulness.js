...
form.addEventListener("submit", function (e) {
  ...
  if (question_sum <= 19) {
    ...
    description.textContent =
      "親愛的，讓我們一起溫柔地開啟靜觀的旅程，您的得分顯示您的靜觀覺察能力目前需要特別的關注與支持。這可能表示您在日常生活中經常感到思緒紛飛，對當下體驗的覺察度可能比較低，也可能常常不自覺地處於忙碌的自動導航狀態。極低的靜觀覺察可能會讓您感到有些疲憊或壓力，但請記得，您並不孤單。請溫柔地邀請自己，積極地開始培養靜觀，可以尋求相關資源或專業人士的溫暖支持，一起探索提升靜觀覺察能力的方法，溫柔地照顧好自己，改善生活品質。這是一個溫柔的邀請，邀請您開啟靜觀的旅程，我們相信，透過溫柔的努力，您一定能感受到內在的平靜與力量。";
      color = "#4EC04E";
  } else if (question_sum <= 38) {
    category.textContent = "靜心啟航";
    description.textContent =
      "沒關係的，我們一起溫柔地探索靜觀，您的得分顯示您的靜觀覺察能力目前還在發展中。這可能表示您在日常生活中比較容易感到分心，或者有時候會不自覺地進入自動導航模式，對當下體驗的覺察相對少一些。低靜觀覺察就像是暫時迷失在生活的小徑中，但別擔心，這都是可以慢慢調整的。請溫柔地鼓勵自己，從現在開始，可以嘗試一些簡單的靜觀練習，溫柔地將注意力帶回當下，就像輕輕地牽起自己的手，引導自己回到當下。這是一個溫柔的提醒，邀請您開始關注並培養靜觀，請相信自己，您一定可以感受到改變。";
      color = "#FFC84A";
  } else if (question_sum <= 57) {
    category.textContent = "靜心之翼";
    description.textContent =
      "很棒的開始！您的得分顯示您的靜觀覺察能力正處於一個美好的成長階段。這表示您已經開始對當下體驗有所覺察，就像一顆正在發芽的種子，充滿著潛力。專注力方面還有進步的空間，這也是非常自然的過程。您可以溫柔地邀請自己，透過一些靜觀練習，例如靜心冥想或靜觀呼吸，來溫柔地滋養您的靜觀覺察能力。這是一個很棒的基礎，代表您已經踏上靜觀的旅程，請給予自己鼓勵與耐心，慢慢地感受成長的美好。";
      color = "#F48847";
  } else {
    category.textContent = "澄心之境";
    description.textContent =
      "真棒！您擁有高度的靜觀覺察，您的得分告訴我們，您在日常生活中展現了非常棒的靜觀覺察能力！這表示您通常能夠溫柔地覺察當下的體驗，並且擁有良好的專注力與覺察力。高靜觀覺察就像一份美好的禮物，它能為您帶來情緒的平穩、壓力的減輕，以及整體幸福感的提升。這真的是一個非常棒的結果，請為自己感到驕傲！繼續保持這份覺察，讓靜觀成為您生活中的溫暖陽光。";
      color = "#EB4841";
  }
