var number_question = 13;
var name_question = "scs";
...
form.addEventListener("submit", function (e) {
  ...
  if (question_sum < 18) {
    category.textContent = "自我關懷程度較低";
    description.textContent =
      "這意味著你對自己比較嚴厲或在面對困難時對自己過於苛刻。培養自我關懷對你的身心健康將有很大的幫助，但可能需要更多的耐心和時間來培養。試著在日常生活中對自己多一些理解和包容，這將有助於提升你的幸福感。";
      color = "#F48847";
  } else if (question_sum < 31) {
    category.textContent = "自我關懷程度適中";
    description.textContent =
      "這意味著你在某些情況下你能夠善待自己。培養更多的自我關懷將有助於你提升應對壓力的能力，並增強內心的平靜和滿意感。繼續學習在日常生活中多給予自己一些理解和支持吧！";
      color = "#FFC84A";
  } else {
    category.textContent = "自我關懷程度較高";
    description.textContent =
  ...
  var data = [
    {
      ...
      mode: "gauge+number",
      gauge: {
        axis: { range: [0, 48], tickvals: [0, 24, 48] },
