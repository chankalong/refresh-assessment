...
var form_interest_other_select = document.querySelector("input[name='interest'][value='other']");
form_interest_other_select.addEventListener("change", function (e) {
  if (form_interest_other_select.checked) {
    ...
    document.getElementById("form_interest_other_wrapper").style.display = "none";
