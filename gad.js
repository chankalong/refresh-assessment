...
form.addEventListener("submit", function (e) {
  ...
  if (question_sum <= 4) {
    category.textContent = "良好";
    description.textContent =
      "你的情緒很健康啊，真好！";
      color = "#4EC04E";
  } else if (question_sum <= 9) {
    category.textContent = "輕微焦慮";
    description.textContent =
      "你可能有輕微焦慮症的病徵，不妨散散步讓自己輕鬆一下，向你的朋友及家人分享你的感受，還可以看看我們為你準備的身心健康貼士，或參加我們在線舉辦的工作坊啊！";
      color = "#FFC84A";
  } else if (question_sum <= 14) {
    category.textContent = "中度焦慮";
    description.textContent =
      "你可能有中度焦慮症的病徵，不妨散散步讓自己輕鬆一下，向你的朋友及家人分享你的感受。除了放鬆心情之外，我們建議你可以考慮輔導服務，我們很樂意為你提供一對一免費線上諮詢服務，讓你進一步了解自己的狀況。";
      color = "#F48847";
  } else {
    category.textContent = "嚴重焦慮";
    description.textContent =
      "你可能感到不適，請盡快尋求專業協助，例如醫生及社工。我們很樂意為你提供一對一免費線上諮詢服務，讓你進一步了解自己的狀況。";
      color = "#EB4841";
  }
